 ...
 * @throws {Error} context not found
 */
export const getCtxFaceApi = () => {
  return getContext<HonoEnv>().get("services").faceApi;
};

/**
 * @throws {Error} context not found
 */
export const getCtxDatabaseService = () => {
  return getContext<HonoEnv>().get("services").databaseService;
};
