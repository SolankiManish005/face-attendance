...
export const zEnv = z
  .object({
    ...
    PG_DATABASE_URL: z.string().min(1, "Postgres database URL is required"),
    // firebase
    ...
    OTEL_EXPORTER_TRACES_HEADERS: stringToJSON.pipe(z.record(z.string(), z.unknown())).optional(),
    OTEL_EXPORTER_LOGS_ENDPOINT: z.string().url().optional(),
    OTEL_EXPORTER_LOGS_HEADERS: stringToJSON.pipe(z.record(z.string(), z.unknown())).optional(),
